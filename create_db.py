...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'rzaman12', 'email': 'rzaman12@terpmail.umd.edu', 'first_name': 'Ryan', 'last_name': 'Zaman',
         'password': generate_password_hash('rzaman12@terpmail.umd.edu', method='pbkdf2:sha256'), 'role': 'STUDENT'},
